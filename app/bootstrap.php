...
include_once '../vendors/phire/Phirehose.php';
include_once '../vendors/phire/UserstreamPhirehose.php';
...
if (strpos($_SERVER['SERVER_NAME'], 'dev.streaming.messages.nexum.ws') !== false) {
